...
//			restClient.applicationId = "Sağlık Gözcüsü";
//			// You should get e-mail from ABBYY Cloud OCR SDK service with the application password
//			restClient.password = "J6H6cn450amY+fNmDv55f7d2";
			restClient.applicationId = "demoappbygirisimciler";
			// You should get e-mail from ABBYY Cloud OCR SDK service with the application password
			restClient.password = "qRQYdWizf5LAclz+Dm3DCfXe";
