...
/**
 * Created by Bdeppy on 4.04.2016.
 */
...
public class GeneralClasses {
    ...
    public static class StatusBar{
        ...
        Activity mActivity;
        public StatusBar(AppCompatActivity context) {
            mActivity = context;
        }
        /**
         * StatusBar (En üst durum çubuğu) rengini set eden fonksiyondur.Kitkat ve üst versiyonlar SDK'lar için bulunmaktadır.
         * Lollipop (5.0 API 21) Material Library kütüphanesine benzetmek adına  Kitkat(4.4 API 19 ) ve üzeri için hazır bir fonksiyon bulunmadığı için yazılmıştır.
         * Kitkat 34.3% oranı ile Android kullanımı en yüksek yüzdeli API'dır.
         * @param statusBar Rengi değiştirilecek status bar
         * @param color Değiştirilecek yeni renk tonu
         */
...
//            int actionBarHeight = getActionBarHeight();
        ...
        public void setStatusBarColor( View statusBar,int color,boolean boyutlandirmaYapilsinMi){
...
//            int actionBarHeight = getActionBarHeight();
        ...
        /**
         * Toolbar(Actionbar-Menu Cubuğu)  Yüksekliğini döndüren fonksiyondur.
         * @return int
         */
        ...
        /**
         * StatusBar (En üst durum çubuğu) Yüksekliğini döndüren fonksiyondur
         * @return int
         */
